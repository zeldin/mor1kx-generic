...
module wb_intercon
   (input         wb_clk_i,
    ...
    output [31:0] wb_vectors_adr_o,
    output [31:0] wb_vectors_dat_o,
    output  [3:0] wb_vectors_sel_o,
    output        wb_vectors_we_o,
    output        wb_vectors_cyc_o,
    output        wb_vectors_stb_o,
    output  [2:0] wb_vectors_cti_o,
    output  [1:0] wb_vectors_bte_o,
    input  [31:0] wb_vectors_dat_i,
    input         wb_vectors_ack_i,
    input         wb_vectors_err_i,
    input         wb_vectors_rty_i);
...
wb_mux
  #(.num_slaves (3),
    .MATCH_ADDR ({32'h00002000, 32'h90000000, 32'he1000000}),
    .MATCH_MASK ({32'hffff2000, 32'hfffffff8, 32'hfffffffe}))
 wb_mux_or1k_d
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_m2s_or1k_d_mem_adr, wb_m2s_resize_uart_adr, wb_m2s_resize_intgen_adr}),
    .wbs_dat_o ({wb_m2s_or1k_d_mem_dat, wb_m2s_resize_uart_dat, wb_m2s_resize_intgen_dat}),
    .wbs_sel_o ({wb_m2s_or1k_d_mem_sel, wb_m2s_resize_uart_sel, wb_m2s_resize_intgen_sel}),
    .wbs_we_o  ({wb_m2s_or1k_d_mem_we, wb_m2s_resize_uart_we, wb_m2s_resize_intgen_we}),
    .wbs_cyc_o ({wb_m2s_or1k_d_mem_cyc, wb_m2s_resize_uart_cyc, wb_m2s_resize_intgen_cyc}),
    .wbs_stb_o ({wb_m2s_or1k_d_mem_stb, wb_m2s_resize_uart_stb, wb_m2s_resize_intgen_stb}),
    .wbs_cti_o ({wb_m2s_or1k_d_mem_cti, wb_m2s_resize_uart_cti, wb_m2s_resize_intgen_cti}),
    .wbs_bte_o ({wb_m2s_or1k_d_mem_bte, wb_m2s_resize_uart_bte, wb_m2s_resize_intgen_bte}),
    .wbs_dat_i ({wb_s2m_or1k_d_mem_dat, wb_s2m_resize_uart_dat, wb_s2m_resize_intgen_dat}),
    .wbs_ack_i ({wb_s2m_or1k_d_mem_ack, wb_s2m_resize_uart_ack, wb_s2m_resize_intgen_ack}),
    .wbs_err_i ({wb_s2m_or1k_d_mem_err, wb_s2m_resize_uart_err, wb_s2m_resize_intgen_err}),
    .wbs_rty_i ({wb_s2m_or1k_d_mem_rty, wb_s2m_resize_uart_rty, wb_s2m_resize_intgen_rty}));

wb_mux
  #(.num_slaves (2),
    .MATCH_ADDR ({32'h00000000, 32'h00002000}),
    .MATCH_MASK ({32'hffffe000, 32'hffff2000}))
 wb_mux_or1k_i
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_vectors_adr_o, wb_m2s_or1k_i_mem_adr}),
    .wbs_dat_o ({wb_vectors_dat_o, wb_m2s_or1k_i_mem_dat}),
    .wbs_sel_o ({wb_vectors_sel_o, wb_m2s_or1k_i_mem_sel}),
    .wbs_we_o  ({wb_vectors_we_o, wb_m2s_or1k_i_mem_we}),
    .wbs_cyc_o ({wb_vectors_cyc_o, wb_m2s_or1k_i_mem_cyc}),
    .wbs_stb_o ({wb_vectors_stb_o, wb_m2s_or1k_i_mem_stb}),
    .wbs_cti_o ({wb_vectors_cti_o, wb_m2s_or1k_i_mem_cti}),
    .wbs_bte_o ({wb_vectors_bte_o, wb_m2s_or1k_i_mem_bte}),
    .wbs_dat_i ({wb_vectors_dat_i, wb_s2m_or1k_i_mem_dat}),
    .wbs_ack_i ({wb_vectors_ack_i, wb_s2m_or1k_i_mem_ack}),
    .wbs_err_i ({wb_vectors_err_i, wb_s2m_or1k_i_mem_err}),
    .wbs_rty_i ({wb_vectors_rty_i, wb_s2m_or1k_i_mem_rty}));

wb_mux
  #(.num_slaves (1),
    .MATCH_ADDR ({32'h00002000}),
    .MATCH_MASK ({32'hffff2000}))
 wb_mux_dbg
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
...
wb_arbiter
 ...
 wb_arbiter_mem
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    .wbm_adr_i ({wb_m2s_or1k_d_mem_adr, wb_m2s_or1k_i_mem_adr, wb_m2s_dbg_mem_adr}),
    .wbm_dat_i ({wb_m2s_or1k_d_mem_dat, wb_m2s_or1k_i_mem_dat, wb_m2s_dbg_mem_dat}),
    .wbm_sel_i ({wb_m2s_or1k_d_mem_sel, wb_m2s_or1k_i_mem_sel, wb_m2s_dbg_mem_sel}),
    .wbm_we_i  ({wb_m2s_or1k_d_mem_we, wb_m2s_or1k_i_mem_we, wb_m2s_dbg_mem_we}),
    .wbm_cyc_i ({wb_m2s_or1k_d_mem_cyc, wb_m2s_or1k_i_mem_cyc, wb_m2s_dbg_mem_cyc}),
    .wbm_stb_i ({wb_m2s_or1k_d_mem_stb, wb_m2s_or1k_i_mem_stb, wb_m2s_dbg_mem_stb}),
    .wbm_cti_i ({wb_m2s_or1k_d_mem_cti, wb_m2s_or1k_i_mem_cti, wb_m2s_dbg_mem_cti}),
    .wbm_bte_i ({wb_m2s_or1k_d_mem_bte, wb_m2s_or1k_i_mem_bte, wb_m2s_dbg_mem_bte}),
    .wbm_dat_o ({wb_s2m_or1k_d_mem_dat, wb_s2m_or1k_i_mem_dat, wb_s2m_dbg_mem_dat}),
    .wbm_ack_o ({wb_s2m_or1k_d_mem_ack, wb_s2m_or1k_i_mem_ack, wb_s2m_dbg_mem_ack}),
    .wbm_err_o ({wb_s2m_or1k_d_mem_err, wb_s2m_or1k_i_mem_err, wb_s2m_dbg_mem_err}),
    .wbm_rty_o ({wb_s2m_or1k_d_mem_rty, wb_s2m_or1k_i_mem_rty, wb_s2m_dbg_mem_rty}),
