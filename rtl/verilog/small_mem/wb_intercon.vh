...
wire [31:0] wb_m2s_vectors_adr;
wire [31:0] wb_m2s_vectors_dat;
wire  [3:0] wb_m2s_vectors_sel;
wire        wb_m2s_vectors_we;
wire        wb_m2s_vectors_cyc;
wire        wb_m2s_vectors_stb;
wire  [2:0] wb_m2s_vectors_cti;
wire  [1:0] wb_m2s_vectors_bte;
wire [31:0] wb_s2m_vectors_dat;
wire        wb_s2m_vectors_ack;
wire        wb_s2m_vectors_err;
wire        wb_s2m_vectors_rty;
...
wb_intercon wb_intercon0
   (.wb_clk_i         (wb_clk),
    ...
    .wb_vectors_adr_o (wb_m2s_vectors_adr),
    .wb_vectors_dat_o (wb_m2s_vectors_dat),
    .wb_vectors_sel_o (wb_m2s_vectors_sel),
    .wb_vectors_we_o  (wb_m2s_vectors_we),
    .wb_vectors_cyc_o (wb_m2s_vectors_cyc),
    .wb_vectors_stb_o (wb_m2s_vectors_stb),
    .wb_vectors_cti_o (wb_m2s_vectors_cti),
    .wb_vectors_bte_o (wb_m2s_vectors_bte),
    .wb_vectors_dat_i (wb_s2m_vectors_dat),
    .wb_vectors_ack_i (wb_s2m_vectors_ack),
    .wb_vectors_err_i (wb_s2m_vectors_err),
    .wb_vectors_rty_i (wb_s2m_vectors_rty));
